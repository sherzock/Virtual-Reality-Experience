...
Shader "EarthShader"
{
	...
	SubShader
	{
		...
		uniform float4 _EarthNormal_ST;
		...
		uniform float4 _MaskMapSea_ST;

		void surf( Input i , inout SurfaceOutputStandard o )
		{
			float2 uv_EarthNormal = i.uv_texcoord * _EarthNormal_ST.xy + _EarthNormal_ST.zw;
			o.Normal = UnpackScaleNormal( tex2D( _EarthNormal, uv_EarthNormal ), _NormalIntensity );
			...
			float2 uv_MaskMapSea = i.uv_texcoord * _MaskMapSea_ST.xy + _MaskMapSea_ST.zw;
			float lerpResult30 = lerp( _SmoothnessLand , _SmoothnessWater , tex2D( _MaskMapSea, uv_MaskMapSea ).r);
...
/*ASEBEGIN
Version=18935
278;73;1635;712;-86.91571;593.6079;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-1333.156,26.84038;Inherit;False;Property;_DarkSideFresnelIntensity;DarkSideFresnelIntensity;6;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;34;298.8772,-205.0647;Inherit;False;Property;_NormalIntensity;NormalIntensity;13;0;Create;True;0;0;0;False;0;False;0;0;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;33;725.3709,-295.5422;Inherit;True;Property;_EarthNormal;EarthNormal;12;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;28;329.2791,60.91061;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=401691A05581C6AB8D32D75D9118CE48521438B9