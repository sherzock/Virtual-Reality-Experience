...
Shader "EarthShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( lerpResult10 + lerpResult42 ).rgb;
			...
			o.Emission = ( ( lerpResult42 * _CloudIntensity ) + ( lerpResult17 + ( clampResult13 * ( tex2D( _LightNightAlbedo, panner38 ) * _LightNightIntensity ) ) ) ).rgb;
...
/*ASEBEGIN
Version=18935
284;73;1687;701;1227.756;495.8599;1.3;True;True
...
ASEEND*/
//CHKSM=C4AF98FA6FC2C4F848EF3E979C182CBC9E7B035D